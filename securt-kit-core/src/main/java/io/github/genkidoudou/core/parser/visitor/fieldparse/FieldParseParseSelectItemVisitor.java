...
public class FieldParseParseSelectItemVisitor extends BaseFieldParseTable implements SelectItemVisitor {
    ...
    private final Integer resultColumnIndex;
    ...
    public static FieldParseParseSelectItemVisitor newInstanceCurLayer(BaseFieldParseTable baseFieldParseTable) {
        return newInstanceCurLayer(baseFieldParseTable, null);
    }
    ...
    private FieldParseParseSelectItemVisitor(int layer,
    ...
    public void visit(SelectItem selectItem) {
        ...
        FieldParseParseExpressionVisitor fieldParseExpressionVisitor =
                FieldParseParseExpressionVisitor.newInstanceCurLayer(this, alias, expression, resultColumnIndex);
