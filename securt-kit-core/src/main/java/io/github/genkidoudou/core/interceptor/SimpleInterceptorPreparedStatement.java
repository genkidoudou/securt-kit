...
import io.github.genkidoudou.core.digest.DigestWriteSupport;
    ...
    public SimpleInterceptorPreparedStatement(PreparedStatement delegate, String sql, String datasourceId) {
        ...
        if (this.skipEncrypt) {
            ...
            try {
                ...
                Set<String> parsedTables = io.github.genkidoudou.core.parser.SqlParseCache.parseTableNames(this.sql);
